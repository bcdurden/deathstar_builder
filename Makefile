...
rancher-bootstrap:
	...
	@sleep 10
	@helm install -n carbide-stigatron-system --create-namespace stigatron-ui --set image.name=$(REGISTRY_URL)/carbide/stigatron-ui $(BOOTSTRAP_DIR)/rancher/stigatron-ui-0.1.20.tgz
